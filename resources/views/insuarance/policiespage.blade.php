                                        ...
                                        <div class="modal-body">
                                            <form>
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" id="inputtext" aria-describedby="emailHelp" placeholder="Enter Policy Name">
                                                    <small id="emailHelp" class="form-text text-muted">Capture the policy name.</small>
                                                </div>

                                                <div class="form-group">
                                                    <label for="tab1">Policy Code</label>
                                                    <input type="text" class="form-control" id="inputtext" aria-describedby="policycode" placeholder="Enter Policy Code">
                                                    <small id="emailHelp" class="form-text text-muted">Capture the policy code.</small>
                                                </div>

                                                <div class="form-group">
                                                    <label for="tab1">Policy Description</label>
                                                    <input type="textarea" class="form-control" id="inputtext" aria-describedby="policycode" placeholder="Enter Policy Description">
